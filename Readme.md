This project is built using Natural Language Processing (NLTK Library) from Python. This library is used to process the english words into simpler and root base form of that word
